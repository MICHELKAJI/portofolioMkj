...
function Realisation (){
    return(
        <div>
            <motion.div initial={{opacity: 0, x: 100}} animate={{opacity: 1, x: 0}} transition={{duration: 1, ease: "easeOut", delay:0.2}} className=" flex flex-row justify-center gap-10 rounded-lg shadow-lg  p-5 bg-gradient-to-t from-neutral-800 to-zinc-900 lg:w-[44rem] w-[28rem]">
