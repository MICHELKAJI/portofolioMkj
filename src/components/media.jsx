    ...
    return(
        <div>
            <div className=' flex flex-col gap-3 text-white font-bold'>
                ...
                <h2>Contact info</h2>
                <div>
                <div className=' flex flex-row gap-2 items-center hover:translate-x-3 transition-all ease-linear hover:text-blue-400'><img className=' h-14 w-14' src={whatsapp} alt="" /> <h3><a href="#" onClick={handleClick}>+243 970607351</a></h3></div>
