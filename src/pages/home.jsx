...
function Home(){
  ...
  const images = [imageOne, imageTow, imageThree, imagess]
    ...
    return (
      <div>
        <main className="flex flex-col h-screen lg:pt-20 pt-20 justify-between font-sans w-full px-5">
          <div className="flex flex-col lg:flex-row md:flex-row justify-between  gap-5">
            <div className="flex flex-col lg:flex-row  items-center gap-5 p-5 rounded-lg shadow-lg bg-gradient-to-t from-neutral-800 to-zinc-900 w-full lg:w-auto">
              <motion.img
                ...
                className="h-24 w-24 lg:h-32 lg:w-32 md:w-32 md:h-32 rounded-full mb-4 lg:mb-0"
                src={avatar}
                alt="avatar"
              />
              <div className="text-center lg:text-left flex flex-col items-center lg:items-start w-full lg:w-auto">
                ...
                <motion.p
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 1, ease: "easeOut", delay: 0.2 }}
                  className="text-white leading-5 lg:leading-6 text-sm lg:text-base w-full lg:w-[30rem] p-2 lg:p-5"
                >
                  Certified web developer who specializes in working with
                  JavaScript, React, Node.js; WordPress, and MongoDB. Currently
                  exploring full-stack freelance development opportunities.
                </motion.p>
              </div>
            </div>

            <div className=" hover:scale-105 transition duration-300 flex flex-col items-center w-full lg:w-[28rem] gap-2 rounded-lg shadow-lg py-5 bg-gradient-to-t from-neutral-800 to-zinc-900 md:h-64 md:px-2">
              <Link to="/projects">
            ...
            <div
              ...
              className=" hidden md:block cursor-pointer hover:bg-red-500 shadow-md hover:scale-105 transition duration-300 flex-col justify-center items-center gap-2 border rounded-lg border-slate-400 p-5 w-full lg:w-auto"
            >
              <img
                className="h-14 w-14 lg:h-28 md:h-32 md:w-32 lg:w-28"
                src={cv}
                alt="cv"
              />
          ...
          <div className=" hidden md:block">
            <div className="flex flex-wrap lg:flex-row lg:justify-between justify-start md:flex-row md:flex-nowrap  md:gap-5 gap-5 mt-5">
              <Link
                to="/service"
                className="hover:bg-red-500 hover:scale-105 transition duration-300 flex flex-col p-5 rounded-lg shadow-lg bg-gradient-to-t from-neutral-800 to-zinc-900 lg:w-96 w-auto"
              >
          ...
          <div className="flex flex-col lg:flex-row md:flex-row gap-4 justify-between">
            <Contact />
            <Knowmore />
            <Platform />
          </div>
